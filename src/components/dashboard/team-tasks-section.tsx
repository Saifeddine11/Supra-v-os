...
function taskRowTone(t: TaskRowMock): StatusBlockTone {
          ...
          {tasks.map((t) => (
            <li
              ...
              className={cn(
                ...
                getStatusBlockSurface(taskRowTone(t), { urgentGlow: Boolean(t.overdue) }),
              )}
            >
...
export function TeamTasksSection({
  ...
  return (
    <SectionCard title="Tâches équipe" description="Échéances du jour et retards — tâches ouvertes en base.">
