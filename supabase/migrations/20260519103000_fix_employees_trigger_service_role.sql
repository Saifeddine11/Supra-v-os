-- Fix: permettre explicitement les updates via service_role dans employees_enforce_update_rls().
-- Symptôme corrigé: "Mise à jour non autorisée" pendant liaison employee.user_id / must_change_password
-- depuis les actions admin serveur (createUser, inviteUserByEmail).
